...
<body class="animsition">
    <div class="page-wrapper">
      ...
      <!-- DATA TABLE-->
     <div class="container">
      <h2>Delete Repair Item</h2>
      <br>
      <form class="form-horizontal" action="delete_repair_back_end.php" method="post">
        <div class="form-group">
          <label class="control-label col-sm-2">Repair ID:</label>
          <div class="col-sm-6">
            <input class="form-control" placeholder="Enter Repair Number" name="RepID">
          </div>
          <div class="col-sm-3 ">
      ...
      <form class="form-horizontal" action="delete_item_back_end.php" method="post">
        <div class="form-group">
          <label class="control-label col-sm-2">Item code:</label>
          <div class="col-sm-6">
            <input class="form-control" placeholder="Enter Item Code" name="ItemCode">
          </div>
          <div class="col-sm-3 ">
            <button class="au-btn au-btn-icon au-btn--blue au-btn--small">Submit</button>
          </div>
      ...
      <form class="form-horizontal" action="delete_customer_back_end.php" method="post">
        <div class="form-group">
          <label class="control-label col-sm-2">Telephone number:</label>
          <div class="col-sm-6">
            <input class="form-control" placeholder="Enter Telephone Number" name="TelNum">
          </div>
          <div class="col-sm-3 ">
            <button class="au-btn au-btn-icon au-btn--blue au-btn--small">Submit</button>
          </div>
