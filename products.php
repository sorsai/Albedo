                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="table-data__tool">
                                ...
                                <h3 class="title-5 m-b-35">Products (Stocks Onhand)</h3>
                                ...
                                <div class="table-data__tool-right">
                                    <a href="new_item_front_end.php"><button class="au-btn au-btn-icon au-btn--green au-btn--small">
                            ...
                            <div class="table-responsive table-responsive-data2">
                                <table class="table table-data2">
                                    ...
                                    <?php
                                        ...
                                        $sql = "SELECT `ITEM`, `SIZE`, `DETAL`, `PRICE`, `COLLECTION` FROM `master_data_test`.`item`;";
                                        ...
                                        <tr class="tr-shadow">
                                            ...
                                            <td>
                                                <div class="table-data-feature">
                                                    ...
                                                    <a href="update_item_front_end.php"><button class="item" data-toggle="tooltip" data-placement="top" title="Edit">
