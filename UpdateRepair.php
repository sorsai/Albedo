...
<body class="animsition">
    <div class="page-wrapper">
      ...
      <!-- DATA TABLE-->
     <div class="container">
  <h2>Update Repair Item</h2>
  <br>
  <form class="form-horizontal" action="update_repair.php" method="post">

    <div class="form-group">
      <label class="control-label col-sm-2">Repaid ID:</label>
      <div class="col-sm-3">
        <input type="CusTel" class="form-control" id="RepID" placeholder="Enter Phone Number" name="RepID">
      </div>
