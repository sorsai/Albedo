...
<body class="animsition">
  ...
  <h2>Add Customer </h2>
  <br>
  <form class="form-horizontal" action="new_customer_back_end.php" method="post">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-3">          
        <input type="tel" class="form-control" id="tel" placeholder="Enter Telephone Number" name="TelNum">
      </div>
       </div>
